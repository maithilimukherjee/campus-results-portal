...
class Student(Base):
    ...
    user_uid = Column(String, unique=True, nullable=False, index=True)  # Firebase UID
    ...
    reevaluations = relationship("Reevaluation", back_populates="student")
...
class Result(Base):
    ...
    published_by_id = Column(UUID(as_uuid=True), ForeignKey("teachers.id"), nullable=True)  # Audit tracking
